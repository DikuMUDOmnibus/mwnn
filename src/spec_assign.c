...
void assign_mobiles(void)
{
  ...
  ASSIGNMOB(3099, cleric);
  ASSIGNMOB(3098, protect_mage);
  ...
  ASSIGNMOB(5313, cleric); /* should be a cleric */
  ASSIGNMOB(5314, cleric); /* should be a cleric */
  ASSIGNMOB(5315, cleric); /* should be a cleric */
  ASSIGNMOB(5316, cleric); /* should be a cleric */
  ASSIGNMOB(5317, cleric);
...
/*  ASSIGNMOB(5400, trainer);
  ASSIGNMOB(5401, trainer);
  ASSIGNMOB(5402, trainer);
  ASSIGNMOB(5403, trainer);*/
...
5402 - Guildmaster (KNGIHT)
5403 - Guildmaster (Thief)
5456 - Guildguard (Mage)
5458 - Guildguard (KNIGHT)
...
*/
  ...
  /*The Training*/
  ASSIGNMOB(18700, align_guard);
  ASSIGNMOB(18701, cleric);
}
