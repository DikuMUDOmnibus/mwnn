...
room_vnum jailed_start_room = 1202; 
 ...
 */
const char *LOGNAME = "log/syslog.txt";
...
"\r\n"
"I want a clean fight. No elbows, groin kicking, eye gouging, or ear biting! Got it!."
"\r\n\r\n";
...
int min_wizlist_lev = LVL_BUILDER;
