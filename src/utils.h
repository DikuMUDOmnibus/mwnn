...
#define SECS_PER_MUD_DAY	(60*SECS_PER_MUD_HOUR)
#define SECS_PER_MUD_MONTH	(60*SECS_PER_MUD_DAY)
#define SECS_PER_MUD_YEAR	(10*SECS_PER_MUD_MONTH)
...
#define GET_BEAST(ch)	((ch)->player.beast)
#define GET_DRACE(ch)   ((ch)->player.drace)
#define GET_BODY(ch)	((ch)->player.body_bits)
#define GET_HOME(ch)	((ch)->player.hometown)
#define GET_KINGDOM(ch) ((ch)->player.kingdom)
#define GET_HEIGHT(ch)	((ch)->player.height)
#define GET_WEIGHT(ch)	((ch)->player.weight)
#define GET_SEX(ch)		((ch)->player.sex)
#define GET_RAGE(ch)	((ch)->player.rage)
#define GET_DEAD(ch)	((ch)->player.dead)
#define GET_NOBLE(ch)	((ch)->player.rank)
#define GET_CHALLENGE(ch)  ((ch)->player.challenge)
#define GET_CHALLENGER(ch)  ((ch)->player.challenger)
#define GET_PKILLS(ch)  ((ch)->player.pkills)
#define GET_PDEATHS(ch) ((ch)->player.pdeath)
#define GET_MKILLS(ch)  ((ch)->player.mkills)
#define GET_MDEATHS(ch) ((ch)->player.mdeath)
#define GET_ADEATHS(ch) ((ch)->player.adeath)
#define GET_AKILLS(ch)  ((ch)->player.akills)
#define GET_GLADIATOR(ch)  ((ch)->player.avatar)
#define GET_WARING(ch)	((ch)->player.waring)
#define GET_GLEVEL(ch)	((ch)->player.glevel)
...
#define GET_RPP(ch)		  ((ch)->points.rpp)
#define GET_QP(ch)	      ((ch)->points.qp)
#define GET_TAXES(ch)	  ((ch)->points.tax)
#define GET_EXP(ch)       ((ch)->points.total_exp)
#define GET_S_EXP(ch)     ((ch)->points.spend_exp)
...
#define GET_SHARES(ch)    ((ch)->points.bank_shares)
#define GET_HITROLL(ch)	  ((ch)->points.hitroll)
#define GET_DAMROLL(ch)   ((ch)->points.damroll)
#define GET_TRAINING(ch)  ((ch)->player_specials->saved.trains)
...
#define GET_JAIL_LEV(ch)		((ch)->player_specials->saved.jail_level)
...
#define CAN_CARRY_N(ch) (5 + (GET_DEX(ch) >> 1))
...
#define RACE_NAME(ch) (IS_NPC(ch) ? "N/A" : pc_race_types[(int) GET_RACE(ch)])
#define CLASS_NAME(ch) (IS_NPC(ch) ? "N/A" : pc_class_types[(int) GET_CLASS(ch)])
#define MROYAL_NAME(ch) (IS_NPC(ch) ? "N/A" : ntitle_male[(int) GET_NOBLE(ch)])
#define FROYAL_NAME(ch) (IS_NPC(ch) ? "N/A" : ntitle_female[(int) GET_NOBLE(ch)])

#define IS_MAGIC_USER(ch)	(!IS_NPC(ch) && \
				((GET_CLASS(ch) == CLASS_LIFE) \
				 || (GET_CLASS(ch) == CLASS_DEATH) \
				 || (GET_CLASS(ch) == CLASS_FIRE) \
				 || (GET_CLASS(ch) == CLASS_WIND) \
				 || (GET_CLASS(ch) == CLASS_WATER) \
				 || (GET_CLASS(ch) == CLASS_EARTH) \
				 || (GET_CLASS(ch) == CLASS_ILLUSION)\
...
#define IS_TRACKER(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_TRACKER))
#define IS_MERC(ch)			(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_MERC))
#define IS_BARD(ch)			(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_BARD))
#define IS_MERCHANT(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_MERCHANT))
#define IS_SPY(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_SPY))
#define IS_GUARD(ch)		(!IS_NPC(ch) && \
				(GET_CLASS(ch) == CLASS_GUARD))
...
#define IS_DRACO(ch)		(!IS_NPC(ch) && \
				(GET_RACE(ch) == RACE_DRACO))
#define IS_WERE(ch)			(!IS_NPC(ch) && \
				(GET_RACE(ch) == RACE_WERE))
#define IS_VAMPYRE(ch)		(!IS_NPC(ch) && \
				(GET_RACE(ch) == RACE_VAMPYRE))
#define IS_TROLL(ch)		(!IS_NPC(ch) && \
				(GET_RACE(ch) == RACE_TROLL))
#define IS_ARIEL(ch)		(!IS_NPC(ch) && \
				(GET_RACE(ch) == RACE_ARIEL))
