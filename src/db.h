...
#define CLAN_FILE LIB_ETC"clans" /*clan files*/
#define BANK_FILE       LIB_ETC"bank" /* for the economy system         */
#define KINGS_FILE	LIB_ETC"kingdom" /*Kingdom Files*/
